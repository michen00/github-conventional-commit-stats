...
class TestGitHubClientBasics:
    ...
    def test_search_repositories(self) -> None:
        ...
        repos = client.search_repositories(
            query="stars:>=100", per_page=10, page=1
        )
...
class TestBackoffCalculation:
    ...
    def test_backoff_has_jitter(self) -> None:
        ...
        results = [
            calculate_backoff_with_jitter(attempt=2, base=1.0)
            for _ in range(10)
        ]
    ...
    def test_backoff_respects_max_delay(self) -> None:
        ...
        backoff = calculate_backoff_with_jitter(
            attempt=10, base=1.0, max_delay=60.0
        )
        assert backoff <= 60.0
...
class TestSearchPagination:
    ...
    def test_pagination_params_passed(self) -> None:
        ...
        client.search_repositories(
            query="stars:100..500", per_page=30, page=2
        )
        ...
        # URL encodes : as %3A
        assert "stars" in url_str and "100..500" in url_str
